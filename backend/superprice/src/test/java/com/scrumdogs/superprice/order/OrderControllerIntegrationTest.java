...
public class OrderControllerIntegrationTest {
    ...
    void shouldReturnOrder_whenValidInformationGiven() throws Exception {
        ...
        mvc.perform(post("/v1/cart/checkout")
                        ...
                        .andExpect(jsonPath("$.details.deliveryWindowStart", is(this.deliveryWindowStart)))
    ...
    @Test
    public void shouldCreateApprovedOrder_withDefaultCustomMessage_whenCustomMessageBlank() throws Exception {
        ...
        mvc.perform(post("/v1/cart/checkout")
                        ...
                        .andExpect(jsonPath("$.details.deliveryDate", is(this.deliveryDate)))
                        .andExpect(jsonPath("$.details.deliveryWindowStart", is(this.deliveryWindowStart)))
                        .andExpect(jsonPath("$.details.customMessage", is(CustomerDetails.DEFAULT_CUSTOM_MSG)))
                        .andExpect(jsonPath("$.cart.totalInCents", is(this.expectedTotalInCents)))
                        .andExpect(jsonPath("$.status", is(OrderStatus.EMAILED.name())));
    }
    ...
    @Test
    public void shouldThrowException_whenNameHasIllegalCharacter() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenInvalidPhoneCharacters() throws Exception {
    ...
    public void shouldThrowException_whenPhoneTooLong() throws Exception {
        ...
        this.phone += "0".repeat(CustomerDetails.MAX_PHONE_LEN - this.phone.length() + 1);

        buildRequestBody(this.root);

        String expected = "Invalid " + "phone" + ": " + CustomerDetails.trimLongString(phone) + ". " +
    ...
    @Test
    public void shouldThrowException_whenAddressHasInvalidCharacter() throws Exception {
    ...
    public void shouldThrowException_whenAddressTooLong() throws Exception {
        ...
        this.address += "a".repeat(CustomerDetails.MAX_ADDR_LEN - this.address.length() + 1);
        buildRequestBody(this.root);

        String expected = "Invalid " + "address" + ": " + CustomerDetails.trimLongString(address) + ". " +
    ...
    @Test
    public void shouldThrowException_whenPostcodeOutOfRange_tooLow() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenPostcodeOutOfRange_tooHigh() throws Exception {
        //Invalidate postcode by putting it outside range.
    ...
    public void shouldThrowException_whenPostcodeTooLong() throws Exception {
        ...
        String expected = "Invalid " + "postcode" + ": " + CustomerDetails.trimLongString(postcode) + ". " +
    ...
    @Test
    public void shouldThrowException_whenDeliveryDateHasIllegalCharacter() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenDeliveryDateIsInThePast() throws Exception {
        //Invalidate delivery date by making it in the past.
        this.deliveryDate = this.deliveryDate.replace("2023", "1985");
        buildRequestBody(this.root);
    ...
    @Test
    public void shouldThrowException_whenDeliveryWindowHasIllegalCharacter() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenDeliveryWindowPoorlyFormatted() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenDeliveryWindowOutOfRange() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenDeliveryWindowOutside24H_format() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenDeliveryWindowHasMinutes() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenItemHasZeroInventoryID() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenItemHasNegativeInventoryID() throws Exception {
    ...
    @Test
    public void shouldThrowException_whenItemHasNegativeQuantity() throws Exception {
